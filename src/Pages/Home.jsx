...
const Home = () => {
    ...
    const [chartType] = useState("bar"); // Pie removed to avoid errors
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-4">
            ...
            <section className="bg-white rounded-xl shadow-lg p-6 mb-6">
                ...
                {/* Only bar chart to avoid PieChart error */}
            ...
            <dialog id="my_modal_1" className="modal">
                <form method="dialog" onSubmit={handleSubmit} className="modal-box bg-white rounded-xl shadow-xl p-6 space-y-4">
                    ...
                    <input type="text" placeholder="Detail" required className="w-full p-3 border rounded-lg"
                        value={formData.detail}
                        onChange={e => setFormData({ ...formData, detail: e.target.value })}
                    />

                    <input type="number" placeholder="Amount (₹)" required className="w-full p-3 border rounded-lg"
                    ...
                    <input type="text" placeholder="Note" required className="w-full p-3 border rounded-lg"
                        value={formData.note}
...
const CategoryCard = ({ label, color, emoji, amount }) => (
    <div className={`${colorMap[color]} p-4 rounded-lg shadow-md`}>
        <h2 className="text-lg font-semibold">{emoji} {label}</h2>
